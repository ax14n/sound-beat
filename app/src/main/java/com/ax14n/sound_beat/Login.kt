...
class Login : ComponentActivity() {
    ...
    @Composable
    fun CreateTextField(label: String, spacer: Dp = 20.dp) {
        ...
        TextField(
            ...
            label = { Text(label) }, // Etiqueta flotante
